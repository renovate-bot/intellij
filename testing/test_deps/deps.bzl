...
def aswb_test_deps_dependencies():
    ...
    http_file(
        ...
        sha256 = "7cdcbac9d74c9f9d27c2b6b1cc75b727676a79454c86086884b45ae987a96927",
        downloaded_file_path = "bazel_central_registry.zip",
        url = "https://github.com/bazelbuild/bazel-central-registry/archive/8d30956c7736737639a1b8aa245858b4964adce1.zip",
        visibility = ["//:__subpackages__"],
    )
